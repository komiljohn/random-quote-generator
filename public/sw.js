(() => {
  ...
  async function l(e, t, a, s) {
    ...
    for (let i of await e.keys(t, n))
      if (r === o(i.url, a)) return e.match(i, s);
  }
  let h = new Set(),
    u = async () => {
  ...
  let R = ["get", "getKey", "getAll", "getAllKeys", "count"],
  ...
  class V {
    ...
    async getDb() {
      return (
        this._db ||
          (this._db = await v("serwist-background-sync", 3, {
  ...
  class ef {
    ...
    constructor({
      ...
      if (
        ...
        void 0 !== n && ((d = { prefix: n }), i.updateDetails(d)),
        a
          ? self.skipWaiting()
        ...
        w.cleanupOutdatedCaches &&
          ((m = g.cacheName),
          self.addEventListener("activate", (e) => {
            e.waitUntil(f(i.getPrecacheName(m)).then((e) => {}));
          })),
        this.registerRoute(new ec(this, p)),
        w.navigateFallback &&
          this.registerRoute(
            new F(this.createHandlerBoundToUrl(w.navigateFallback), {
...
This is generally NOT safe. Learn more at https://bit.ly/wb-precache`));
    ...
    constructor(e = {}) {
      ((this._config = e),
        ...
        this._config.purgeOnQuotaError &&
          h.add(() => this.deleteCacheAndMetadata()));
    }
  ...
  new ef({
    precacheEntries: [
      {
        revision: "f24f63e3e29c055f0a80f5e6d34db543",
        url: "/_next/static/RAv_m83AXLSw3YuU_CaFf/_buildManifest.js",
      },
      {
        revision: "b6652df95db52feb4daf4eca35380933",
        url: "/_next/static/RAv_m83AXLSw3YuU_CaFf/_ssgManifest.js",
      },
      { revision: null, url: "/_next/static/chunks/43-3bc77f5128adbe87.js" },
      { revision: null, url: "/_next/static/chunks/59-467ccfedc79f880f.js" },
      {
        revision: null,
        url: "/_next/static/chunks/65c9724e-14516d8804cd7096.js",
      },
      { revision: null, url: "/_next/static/chunks/802-f92e04b7178cfcee.js" },
      {
        revision: null,
        url: "/_next/static/chunks/app/_not-found/page-ce1d94160b2cb9af.js",
      },
      {
        revision: null,
        url: "/_next/static/chunks/app/layout-e7e0a17432817aff.js",
      },
      {
        revision: null,
        url: "/_next/static/chunks/app/page-08a65e00309b17f7.js",
      },
      {
        revision: null,
        url: "/_next/static/chunks/framework-4d8574e6060ef183.js",
      },
      { revision: null, url: "/_next/static/chunks/main-2723ba7fd20a22d1.js" },
      {
        revision: null,
        url: "/_next/static/chunks/main-app-1b41545cf941d011.js",
      },
      {
        revision: null,
        url: "/_next/static/chunks/pages/_app-cdbdc3cad2a29da9.js",
      },
      {
        revision: null,
        url: "/_next/static/chunks/pages/_error-a8ae343b5d8241d5.js",
      },
      {
      ...
      {
        revision: null,
        url: "/_next/static/chunks/webpack-ce124499b840915c.js",
      },
      { revision: null, url: "/_next/static/css/c3329dede3cf5449.css" },
      {
      ...
      {
        revision: "70fdd7a287c71bcbc3aa58ce84042dbf",
        url: "/android-chrome-192x192.png",
      },
      {
        revision: "8f550024cfaee0ae5804dac357b4e263",
        url: "/android-chrome-512x512.png",
      },
      {
        revision: "399258c6a690d8d50621c4642b693539",
      ...
      {
        revision: "8403667290bd00d56ec37ec3645d215f",
        url: "/apple-touch-icon.png",
      },
      { revision: "dcb534f35193b96649afc899658614f2", url: "/favicon.ico" },
      ...
      {
        revision: "2b34b65094d8ab3b1c90646ef53e12c3",
        url: "/service-worker/app-worker.ts",
      },
